...
export const Details: React.FC<ShiftDetailsDescriptionProps> = ({ description }) => {
  return (
    <View style={tw`flex flex-col items-start text-xs mt-3 tracking-tight rounded-none max-w-[359px]`}>
        ...
        <Text style={tw`font-semibold leading-6 text-neutral-400 text-sm tracking-tight`}>Details</Text>
        <Text style={tw`text-zinc-600 tracking-tight text-sm text-neutral-500`}>{description}</Text>
