...
import type { NotificationDetailsProps, UserListItemProps } from '../(tabs)/types';

import tw from "twrnc";
import { images } from '@/assets/images';
import { StatsCounter } from './StatsCounterUserList';

const EmployersListItem: React.FC<UserListItemProps> = ({ name , ratings, assurance, avatar }) => {
  return (
