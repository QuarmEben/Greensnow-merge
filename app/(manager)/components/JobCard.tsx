      ...
      <View style={tw`flex flex-col justify-center px-2 py-2 w-full bg-white rounded-xl shadow-[0px_2px_4px_rgba(0,0,0,0.25)] w-full h-[211px] shadow-lg`}>
        <View style={tw`flex flex-col px-2.5 py-3 w-full overflow-hidden aspect-[1.778] h-[194px]`}>
          ...
          <View style={tw`flex flex-row relative items-center self-end absolute bottom-2 right-2`}>
            ...
            {hourlyRate != null ?
              <Text style={tw`text-sm font-semibold tracking-tight leading-6 text-center text-white`}>${parseFloat(hourlyRate).toFixed(2)} /hr </Text> :
              <Text style={tw`text-sm font-semibold tracking-tight leading-6 text-center text-white`}>${hourlyRate}/hr </Text>
            }
            </View>
            ...
            <View style={tw`self-stretch my-auto`}>
            {totalAmount != null ?
              <Text style={tw`text-sm font-semibold tracking-tight leading-6 text-center text-white`}> ${parseFloat(totalAmount).toFixed(2)}</Text> :
              <Text style={tw`text-sm font-semibold tracking-tight leading-6 text-center text-white`}> ${totalAmount}</Text>
            }
            </View>
          </View>
        </View>
