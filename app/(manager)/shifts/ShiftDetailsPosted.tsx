...
import { View, Text, Image, TouchableOpacity, ScrollView, Modal, LogBox, ActivityIndicator, Pressable } from "react-native";
...
const ShiftDetailsPreview: React.FC = () => {
  ...
  const { shiftType, date, numberOfHours ,time, endTime, hourlyRate, totalEarnings, location, description, employeeId, employerId, employee, employer  } = useLocalSearchParams<ShiftDetailsProps>();
