...
import { View, Text, Image, TouchableOpacity, Alert, Modal, ScrollView, Pressable, FlatList, LogBox } from 'react-native';
...
import { ButtonProps, RatingIndicatorProps, ShiftDetailsProps } from './types';
...
onPress={() => router.push({
  pathname: "/shifts/UpComingShiftDetailsBegan",
  params: {
    id: item.id
  }}
) }
>
  <Text style={tw`text-white self-center text-xl font-semibold tracking-tight`}>Begin Shift</Text>
</TouchableOpacity>
