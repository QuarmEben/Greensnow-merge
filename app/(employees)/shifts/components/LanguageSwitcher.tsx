...
const LanguageSwitcher: React.FC<LanguageSwitcherProps> = ({
  ...
  return (
    <View style={tw`flex text-xs self-stretch text-center whitespace-nowrap max-w-[66px] w-66 text-zinc-600`}>
      <View style={tw`flex flex-row gap-2.5 px-1.5 py-1.5 self-stretch bg-white shadow-[0px_2px_4px_rgba(0,0,0,0.25)]`}>
        ...
        {  isOpen ?
        <View style={tw`flex absolute top-7 px-2 bg-white`}>
