...
const HomeNotVerified: React.FC = () => {
  return (
    <View style={tw`flex-1 overflow-hidden flex-col pt-15 items-center w-full text-center bg-zinc-100 max-w-[480px]`}>
      ...
      <View style = {tw`mt-4 w-[232px]`}>
        ...
        <TouchableOpacity onPress={() => router.push("/home/HomePostedShifts")}>
