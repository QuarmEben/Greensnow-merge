     ...
     <UserHeader 
      ...
      <View style={tw`flex mt-5 w-full`}>
            <View style={tw`flex flex-row items-start gap-2.5 w-64 max-w-full rounded-none w-full`}>
                    ...
                    <TouchableOpacity>
                    <Text style={tw`grow text-green-700 text-base font-extrabold tracking-tight leading-loose underline`}>Posted Shifts</Text>
                    </TouchableOpacity>
            
                    <TouchableOpacity>
                    <Text style={tw`grow shrink text-stone-900 text-base font-extrabold tracking-tight leading-loose`}>Shifts Taken</Text>
                    </TouchableOpacity>
